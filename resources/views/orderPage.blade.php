            ...
            <div class="md:px-2">
                ...
                <div class="flex items-center justify-between ">
                    ...
                    @if ($booth->status == 'tersedia')
                        @if(auth()->check())
                            <a class="text-white bg-secondary hover:opacity-80 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center cursor-pointer" data-modal-toggle="default-modal">Pesan</a>
                        @else
                            <a href="{{ route('login') }}" class="text-white bg-secondary hover:opacity-80 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center cursor-pointer">Pesan</a>
                        @endif
                    @else
